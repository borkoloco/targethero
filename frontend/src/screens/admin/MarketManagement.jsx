...
<<<<<<<< HEAD:frontend/src/components/Marketplace/MarketManagement.jsx
...
========
import MarketItemForm from "../../components/admin/MarketItemForm";
import ModalWrapper from "../../components/common/ModalWrapper";
import SortableTableHeader from "../../components/common/SortableTableHeader";
import ScrollableTable from "../../components/common/ScrollableTable";
>>>>>>>> d78a76c85fc6a3b61591cd248d296dbf2019b4c9:frontend/src/screens/admin/MarketManagement.jsx
...
function MarketManagement() {
  ...
  return (
    <div className="p-6 bg-white rounded-2xl shadow-xl">
      ...
      <h2 className="text-xl font-bold mb-2 text-[#6e66f3] ">
        Market Items List
      </h2>
      {error && (
      ...
      <h3 className="text-xl font-bold mt-10 mb-2 text-[#6e66f3]">
        User Market Report
      </h3>
      {reportError && (
