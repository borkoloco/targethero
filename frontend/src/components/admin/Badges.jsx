...
import BulkImportForm from "../Modal/BulkImportForm";
...
<<<<<<<< HEAD:frontend/src/components/Badges/Badges.jsx
...
>>>>>>>> d78a76c85fc6a3b61591cd248d296dbf2019b4c9:frontend/src/components/admin/Badges.jsx
    ...
    <div className="mt-8 p-6 bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 font-sans">
      ...
      >
        <form
          ...
          className="space-y-4 flex flex-col md:flex-row md:space-y-0 md:space-x-6"
        >
