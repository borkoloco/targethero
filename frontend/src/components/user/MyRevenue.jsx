...
<<<<<<<< HEAD:frontend/src/components/Revenue/MyRevenue.jsx
...
>>>>>>>> d78a76c85fc6a3b61591cd248d296dbf2019b4c9:frontend/src/components/user/MyRevenue.jsx
  ...
  return (
    <div className="mt-8 p-6 bg-white shadow-lg rounded-2xl">
      ...
      {revenue.length === 0 ? (
        ...
        <ScrollableTable>
          <thead className="sticky top-0 bg-[#fc875e] !important z-10 shadow-sm">
            <tr className="text-white">
              ...
              <SortableTableHeader
                ...
                className="border p-3 bg-[#fc875e] hover:bg-[#fc875e] active:bg-[#fc875e]"
              />
              <SortableTableHeader
                label="Type"
                field="type"
