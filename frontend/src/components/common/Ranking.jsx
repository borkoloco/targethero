...
<<<<<<<< HEAD:frontend/src/components/Users/Ranking.jsx
...
========
            ...
            <SortableTableHeader
              ...
              onSortChange={toggleSort}
            />
>>>>>>>> d78a76c85fc6a3b61591cd248d296dbf2019b4c9:frontend/src/components/common/Ranking.jsx
          </tr>
        </thead>
        <tbody>
          {sortedRanking.map((user, index) => (
            <tr key={user.id} className="hover:bg-gray-100 transition">
              ...
              <td className="border p-2">{user.badges || 0}</td>
            </tr>
          ))}
        </tbody>
      </ScrollableTable>
